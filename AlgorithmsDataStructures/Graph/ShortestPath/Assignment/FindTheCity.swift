...
//
//  Created by Kazunobu Someya on 2021-04-18.
//
...
//        print(dist)
        ...
        for u in 0..<dist.count {
            ...
            for v in 0..<dist.count {
                ...
                if dist[u][v] <= distanceThreshold || dist[v][u] <= distanceThreshold {
                    count += 1
                }
            }
            dict[u] = count
...
//        print(dict)
        ...
        let sortedByCount = dict.sorted { $0.value < $1.value || ($0.value == $1.value && $0.key > $1.key) }
